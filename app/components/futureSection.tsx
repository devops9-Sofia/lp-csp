...
const items = [
    { icon: "/icons/star-icon.svg", strong: "Destacar", text: "a sua marca" },
    ...
    return (
        <section className="pt-10 pb-5">
            <div className="flex flex-col max-w-5xl mx-auto justify-center ">
                ...
                <div className="flex gap-5  max-w-3xl items-center mx-auto ">
                    ...
                    <img src="/elements/linhas.layout.svg" alt="linhas" className="" />
                    </div>
                </div>

                <div className="mx-auto max-w-3xl grid grid-cols-[1.5fr_0.90fr] gap-8 items-start ">
