...
export function Navbar() {
  ...
  return (
    <header className=" absolute w-full h-[5rem] items-center top-0 left-0 right-0 z-50">
      ...
      <div className=" mt-2 mx-auto w-[60%] h-12 px-6 py-5 flex items-center justify-between gap-2 bg-white rounded-xl">
        ...
        <nav className="flex items-center gap-2 text-sm text-gray-600 whitespace-nowrap">
          {links.map((l) => (
